...
# MLOps on Azure
This repository contains code, which is used for a MLOps Project.

In this project various cloud services will be used, e.g. [Azure ML Services](https://azure.microsoft.com/en-us/services/machine-learning-service/) and [Azure DevOps](https://azure.microsoft.com/en-us/services/devops/).
...
Azure ML contains a number of asset management and orchestration services to help us manage the lifecycle of your model training & deployment workflows.
